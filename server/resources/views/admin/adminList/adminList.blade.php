    ...
    <div class="row justify-content-between align-items-center my-3 mx-1">
        <div class="col-6 col-md-2 mb-2 mb-md-0">
            @if (Auth::user()->role == 'superadmin') 
                <a href="{{route('admin#addpage')}}" class="btn btn-primary text-white "><i class="fa-solid fa-plus"></i></a>
            @endif
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class=" d-flex align-items-center justify-content-center ">
                            <a href="{{route('admin#delete',$item->id)}}" class="btn btn-sm btn-danger cursor-pointer"><i class="fa-solid fa-trash"></i></a>
                        </div>
                    </td>
                    @endif
                </tr>
