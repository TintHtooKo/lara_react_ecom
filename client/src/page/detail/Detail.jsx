  ...
  useEffect(() => {
    const fetchProduct = async () => {
      let res = await axios.get(
        import.meta.env.VITE_BACKEND_URL + "/product/detail/" + id
      );
      setProduct(res.data);
      ...
      <div className="container-fluid py-5">
        <div className="row px-xl-5">
          ...
          <div className="col-lg-7 pb-5">
            ...
            <h5
              className="font-weight-semi-bold text-muted mb-4"
            ...
            <div className="d-flex align-items-center mb-4 pt-2">
              ...
              >
                <div className="input-group-btn">
                  <button onClick={minusQty} className="btn btn-primary btn-minus">
                ...
                />
                <div className="input-group-btn">
                  <button onClick={plusQty} className="btn btn-primary btn-plus">
