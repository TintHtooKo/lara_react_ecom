...
export default function Shop() {
  ...
  const categoryFilter = async(e)=>{
    ...
    e.preventDefault();
      try {
        let res;
        if(selectCategory){
          res = await axios.post(import.meta.env.VITE_BACKEND_URL+'/category/search',{id:selectCategory});
        }else{
  ...
  const productFilter = async(e)=>{
    ...
    try {
      if(productSearch){
        let res = await axios.post(import.meta.env.VITE_BACKEND_URL+'/product/search',{name:productSearch});
        setProduct(res.data)
      }else{
        let res = await axios.get(import.meta.env.VITE_BACKEND_URL+'/product');
        setProduct(res.data)
      ...
      <div className="container-fluid pt-5">
        <div className="row px-xl-5">
          ...
          <div className="border-bottom mb-4 pb-4">
              ...
              <select value={selectCategory} onChange={(e)=>setSelectCategory(e.target.value)} className="form-control" id="">
